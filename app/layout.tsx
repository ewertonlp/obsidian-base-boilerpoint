...
export const metadata: Metadata = {
  ...
  description:
    "The ultimate Next.js boilerplate with Supabase Auth, Stripe billing, and premium UI components out of the box.",
  ...
  openGraph: {
    ...
    description:
      "Launch your SaaS faster with our premium Next.js boilerplate.",
    url: APP_URL,
    ...
    >
      <body className="min-h-full flex flex-col font-sans">
        ...
        <Toaster
          ...
          toastOptions={{
            className:
              "bg-obsidian-surface/80 backdrop-blur-xl border border-obsidian-border/50 text-text-primary shadow-2xl rounded-xl",
